...
'customer_email' => 'noreply@oylite.com',
                'license_limit' => 0,
                'site_count' => 1,
...
update_option('_ff_fluentform_pro_license_key', 'OYLITE0000000005603B1EBE56D0D7F8');
...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) { if (strpos($url, 'api3.wpmanageninja.com') !== false) { return array( 'headers' => array(), 'body' => json_encode(array( 'license' => 'valid', 'item_name' => 'Fluent Forms Pro Add On', 'expires' => 'lifetime', 'payment_id' => '12345', 'customer_name' => 'OYLITE', 'customer_email' => 'noreply@oylite.com', 'license_limit' => 0, 'site_count' => 1, 'activations_left' => 'unlimited' )), 'response' => array('code' => 200, 'message' => 'OK'), 'cookies' => array(), 'filename' => null ); } return $preempt; }, 10, 3); update_option('_ff_fluentform_pro_license_key', 'OYLITE0000000005603B1EBE56D0D7F8'); update_option('_ff_fluentform_pro_license_status', 'valid'); update_option('_ff_fluentform_pro_license_status_checking', (object)array( 'license' => 'valid', 'item_name' => 'Fluent Forms Pro Add On', 'expires' => 'lifetime', 'payment_id' => '12345', 'customer_name' => 'OYLITE', 'customer_email' => 'noreply@oylite.com', 'license_limit' => 0, 'site_count' => 1, 'activations_left' => 'unlimited', 'next_timestamp' => time() + (365 * 24 * 60 * 60) ));
